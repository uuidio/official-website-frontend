<template>
  <div class="home" style="width: 1200PX;margin: 0 auto">
    <div style="position: relative;margin-top:60PX;">
      <div style="width:690PX"><img src="https://rescdn.www.smartconns.com/assets/img/06_company_bg.png" alt=""></div>
      <div style="position: absolute;right: 10PX;top: 0;width: 500PX;">
        ...
        <div style="font-size: 26PX;color: #00b0e1">公司愿景——让超市生意更好做</div>
        <div style="font-size: 26PX;color: #00b0e1;margin-top:30PX;">价值观——为客户创造价值</div>
        </div>
      </div>
    </div>

    <div style="text-align:center;margin-top: 100PX;">
      <p class="nav_title">所获荣誉</p>
      ...
      <div class="clearfix" style="margin-top: 80PX;">
        <div style="width: 560PX;float: left;">
          <img src="https://rescdn.www.smartconns.com/assets/img/06_about_us_01.png" alt="">
          <p style="color: #a9a9a9;font-size: 14PX;text-align:center;line-height: 30PX;">2018年11月1日-3日于昆明 <br>
            ChinaShop 2018第二十届中国零售业博览会最高人气关注奖（金翼奖）</p>
        </div>
    ...
    <div style="text-align:center;margin-top: 100PX;">
      <p class="nav_title">核心技术专利和资质</p>
      <div><img src="https://rescdn.www.smartconns.com/assets/img/01_title_line.png" alt=""></div>
      <p style="font-size: 18PX;margin-top: 30PX;">获得 <span style="font-size: 26PX;color:red;font-weight:bold;">30</span> 多项自主创新专利及高新企业资质，技术驱动，我们一直在路上</p>
      <img src="https://rescdn.www.smartconns.com/assets/img/06-sdf.png" alt="" style="margin-top: 50PX;">
    </div>

    <div style="text-align:center;margin-top: 100PX;">
      <p class="nav_title">客户案例分享</p>
      <div><img src="https://rescdn.www.smartconns.com/assets/img/01_title_line.png" alt=""></div>
      <p style="font-size: 18PX;margin-top: 30PX;">降本增效，持续高效服务商超客户，实现坪效，人效，钱效</p>
      <div class="clearfix" style="margin-top: 80PX;">
        <div style="float:left;text-align: left;"><img src="@/assets/image/06_sample_01.png" alt=""></div>
        <div style="float:left;width: 390PX;text-align: left;margin-left: 100PX;">
          <img src="https://rescdn.www.smartconns.com/assets/img/06_sample_02.png" alt="">
          <p style="font-size: 22PX;margin-top:12PX;">全国TOP1大店</p>
          <p style="font-size: 26PX;margin-top:16PX;">广州三元里店部署</p>
          <p style="margin-top:20PX;"><span style="color: #999;">门店面积：</span><span>1200㎡</span></p>
          <p style="margin-top:20PX;"><span style="color: #999 ">上线时间：</span><span>2019.9</span></p>
          <p style="margin-top:20PX;"><span style="color: #999 ">部署投入：</span><span><span style="color: red">400</span>台购物车和3条智能查验通道</span></p>
          <p style="margin-top:20PX;"><span style="color: #999 ">成本节省：</span><span>3个月后，每月节省人工成本 <span style="color: red">10多万</span>，环比降本<span style="color: red">30%</span>
                 （拆除<span style="color: red">10台</span>收银机，减少<span style="color: red">11个</span>收银员）</span></p>
        </div>
      </div>
      <img src="@/assets/image/06_sdfsdf.png" alt="" style="margin-top: 40PX;">
    </div>
